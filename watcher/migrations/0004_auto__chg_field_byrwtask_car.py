...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ByRwTask.car'
        db.alter_column(u'watcher_byrwtask', 'car', self.gf('django.db.models.fields.CharField')(max_length=5))

    def backwards(self, orm):

        # Changing field 'ByRwTask.car'
        db.alter_column(u'watcher_byrwtask', 'car', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        u'watcher.byrwtask': {
            ...
            'car': ('django.db.models.fields.CharField', [], {'default': "'ANY'", 'max_length': '5'}),
