...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ByRwTask.is_successful'
        db.add_column(u'watcher_byrwtask', 'is_successful',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ByRwTask.is_successful'
        db.delete_column(u'watcher_byrwtask', 'is_successful')
