...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ByRwTask.is_active'
        db.add_column(u'watcher_byrwtask', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ByRwTask.is_active'
        db.delete_column(u'watcher_byrwtask', 'is_active')
